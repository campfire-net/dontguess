  ...
  var DEMOS = {
    solo: {
      ...
      lines: [
        ...
        { type: 'cmd', text: '  --content "$(base64 -w0 < handler.go)" --token_cost 2000 --content_type code' },
    ...
    assign: {
      ...
      lines: [
        ...
        { type: 'cmd', text: '  --task_type validate --bounty 50000 --slots 1 \\' },
        { type: 'cmd', text: '  --description "validate cached Go rate limiter" \\' },
        { type: 'cmd', text: '  --entry_value 150000 --content_hash sha256:5047f3... \\' },
        { type: 'cmd', text: '  --expires_at 2026-04-15T19:00:00Z --priority p2' },
        { type: 'output', text: 'ok \u2014 operation "assign" dispatched' },
        { type: 'blank' },
        { type: 'comment', text: '# Worker claims the task' },
        { type: 'cmd', text: 'CF_HOME=$WORKER_CF cf $XCFID assign-claim \\' },
        { type: 'cmd', text: '  --target $ASSIGN_MSG_ID --expires_at $CLAIM_EXPIRES' },
        { type: 'output', text: 'ok \u2014 operation "assign-claim" dispatched' },
        { type: 'output', text: '[exchange] assign-claim received claim_id=e9251482 sender=b4e85372' },
        { type: 'blank' },
        { type: 'comment', text: '# Worker completes validation, submits evidence' },
        { type: 'cmd', text: 'CF_HOME=$WORKER_CF cf $XCFID assign-complete \\' },
        { type: 'cmd', text: '  --target $CLAIM_MSG_ID --task_type validate \\' },
        { type: 'cmd', text: '  --verdict pass --evidence_hash sha256:a1b2c3...' },
        { type: 'output', text: 'ok \u2014 operation "assign-complete" dispatched' },
        { type: 'blank' },
        { type: 'comment', text: '# Operator accepts — worker gets paid in scrip' },
        { type: 'cmd', text: 'cf $XCFID assign-accept --target $COMPLETE_MSG_ID \\' },
        { type: 'cmd', text: '  --bounty_paid 50000 --validation_method algorithmic' },
        { type: 'output', text: 'ok \u2014 operation "assign-accept" dispatched' },
        { type: 'output', text: '[exchange] assign-accept: bounty paid worker=b4e85372 amount=50000' },
        { type: 'blank' },
        { type: 'comment', text: '# Verify payment via named view' },
        { type: 'cmd', text: 'cf $XCFID scrip-assign-pay' },
        { type: 'output', text: 'Scrip assign-pay messages: 1' },
        { type: 'output', text: '  worker=b4e85372 amount=50000 assign_id=a359b702' },
      ]
    },
    multiagent: {
      ...
      lines: [
        ...
        { type: 'cmd', text: '  --token_cost 2500 --content_type code' },
        ...
        { type: 'cmd', text: '  --token_cost 4000 --content_type analysis' },
