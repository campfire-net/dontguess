  ...
  var DEMOS = {
    solo: {
      ...
      lines: [
        ...
        { type: 'cmd', text: 'cf send $CAMPFIRE_ID \'{"description":"Go HTTP handler..."\' \\' },
        { type: 'cmd', text: '  --tag exchange:put --tag exchange:content-type:code' },
        ...
        { type: 'cmd', text: 'cf send $CAMPFIRE_ID \'{"task":"Go HTTP handler for POST JSON"}\' \\' },
        { type: 'cmd', text: '  --tag exchange:buy --future' },
        { type: 'output', text: 'buy message ID: ec08a2dd-4f9f...' },
        { type: 'blank' },
        { type: 'comment', text: '# Match arrives — buyer gets the cached result' },
        { type: 'cmd', text: 'cf read $CAMPFIRE_ID --all --tag exchange:match' },
    ...
    multiagent: {
      ...
      lines: [
        ...
        { type: 'blank' },
        { type: 'cmd', text: 'CF_HOME=$SELLER_CF cf send $XCFID \'{"description":"Go rate limiter...", "token_cost":2500}\' \\' },
        { type: 'cmd', text: '  --tag exchange:put --tag exchange:content-type:code' },
        { type: 'output', text: 'put 1 (code) message ID: 12faabfe-02c0...' },
        { type: 'cmd', text: 'CF_HOME=$SELLER_CF cf send $XCFID \'{"description":"Terraform VPC analysis...", "token_cost":4000}\' \\' },
        { type: 'cmd', text: '  --tag exchange:put --tag exchange:content-type:analysis' },
        ...
        { type: 'cmd', text: 'CF_HOME=$BUYER_CF cf send $XCFID \'{"task":"rate limiter in Go","budget":5000}\' \\' },
        { type: 'cmd', text: '  --tag exchange:buy --future' },
        { type: 'blank' },
        { type: 'cmd', text: 'cf read $XCFID --all --tag exchange:match' },
        { type: 'output', text: 'Match messages: 1' },
        ...
        { type: 'cmd', text: 'cf read $XCFID --all --json | python3 -c "import json,sys; msgs=json.load(sys.stdin); print(len(msgs))"' },
        { type: 'output', text: '35' },
      ]
    }
  };
